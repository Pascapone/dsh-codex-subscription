...
| **Subscription transcription (experimental)** | Enable in **Settings → Codex → Advanced**. The composer microphone records directly in this plugin: X discards, Stop inserts text into your draft, Arrow transcribes and sends. Audio goes to ChatGPT using your existing OAuth login. No separate voice plugin; off by default. |
