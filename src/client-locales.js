export const zh = {
  ...
  transcriptionTitle: '订阅语音转文字', transcription_on: '开启', transcription_off: '关闭',
  transcriptionHint: '实验功能，默认关闭。复用现有订阅登录，录音发送到 ChatGPT；停止后填入草稿，或点击发送箭头直接提交。无需其他语音插件。',
  voiceStart: '开始录音', voiceStop: '停止并转写', voiceSend: '转写并发送', voiceCancel: '取消录音', voiceInsert: '插入转写', voiceRetry: '重试',
  voiceRecording: '正在录音…', voiceTranscribing: '正在转写…', voicePermission: '正在请求麦克风权限…', voiceEmpty: '录音为空', voiceLarge: '录音超过 25 MB',
  voiceFailed: '语音转写失败，请重试。', voiceSignedOut: '请先登录 ChatGPT 订阅。', voiceRenew: '登录已失效，请重新登录。', voiceDenied: '麦克风权限被拒绝。', voiceUnavailable: '当前浏览器不支持录音。', voiceChanged: '草稿已变化，请手动插入转写。',
  ...
  modelMenuAria: '模型、推理等级、速度与输出详略', modelClose: '关闭模型选择', modelBack: '返回', modelLabel: '模型', effortLabel: '推理等级', providerDefault: 'Default', selectModel: '选择模型',
...
export const en = {
  ...
  transcriptionTitle: 'Subscription transcription', transcription_on: 'On', transcription_off: 'Off',
  ...
  voiceStart: 'Start recording', voiceStop: 'Stop and transcribe', voiceSend: 'Transcribe and send', voiceCancel: 'Cancel recording', voiceInsert: 'Insert transcript', voiceRetry: 'Retry',
  voiceRecording: 'Recording…', voiceTranscribing: 'Transcribing…', voicePermission: 'Requesting microphone access…', voiceEmpty: 'Recording is empty', voiceLarge: 'Recording exceeds 25 MB',
  voiceFailed: 'Transcription failed. Try again.', voiceSignedOut: 'Sign in to your ChatGPT subscription first.', voiceRenew: 'Sign in to ChatGPT again.', voiceDenied: 'Microphone permission denied.', voiceUnavailable: 'Recording is unavailable in this browser.', voiceChanged: 'Your draft changed. Insert the transcript manually.',
  ...
  modelMenuAria: 'Model, effort, speed, and output detail', modelClose: 'Close model picker', modelBack: 'Back', modelLabel: 'Model', effortLabel: 'Effort', providerDefault: 'Default', selectModel: 'Select model',
