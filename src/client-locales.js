export const zh = {
  ...
  modelMenuAria: '模型、推理等级、速度与输出详略', modelBack: '返回', modelLabel: '模型', effortLabel: '推理等级', providerDefault: 'Default', selectModel: '选择模型',
...
export const en = {
  ...
  modelMenuAria: 'Model, effort, speed, and output detail', modelBack: 'Back', modelLabel: 'Model', effortLabel: 'Effort', providerDefault: 'Default', selectModel: 'Select model',
