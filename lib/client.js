			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						role: "status",
						"aria-label": t(phase === "recording" ? "voiceRecording" : phase === "permission" ? "voicePermission" : "voiceTranscribing"),
						children: phase === "feedback" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
							error,
							" ",
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
						...
						] }) : phase === "recording" ? Array.from({ length: 74 }, (_, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { height: `${Math.max(2, 3 + Math.abs(Math.sin(i * 2.43)) * Math.min(25, level * 35))}px` } }, i)) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(phase === "permission" ? "voicePermission" : "voiceTranscribing") })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
