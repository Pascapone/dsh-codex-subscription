...
`;
		...
		*/
		...
		function CodexVoiceInput({ sessionId, inputActions, onActiveChange, locked, preference, rpc, t }) {
			const { transcriptionEnabled } = usePreferenceSnapshot(preference);
			const [phase, setPhase] = (0, react.useState)("idle");
			const [wave, setWave] = (0, react.useState)(() => Array(60).fill(0));
			...
			const finish = async (send) => {
				...
				try {
					...
					const value = unwrap(await rpc.call(CHANNEL, "transcription/transcribe", {
					...
					active.current = null;
					release(recording);
					setError(failure?.message === "ChatGPT subscription is not signed in" ? t("voiceSignedOut") : failure?.message === "ChatGPT sign-in needs to be renewed" ? t("voiceRenew") : [t("voiceEmpty"), t("voiceLarge")].includes(failure?.message) ? failure.message : t("voiceFailed"));
					setPhase("idle");
				}
			};
			const start = async () => {
				...
				try {
					...
					recorder.onstop = () => {
						if (run === generation.current && !recording.finishing) {
							cancel();
							setError(t("voiceFailed"));
						}
					};
					if (typeof AudioContext !== "undefined") try {
						...
						recording.waveTimer = setInterval(() => {
							...
							setElapsed(Math.floor((performance.now() - recording.startedAt) / 1e3));
						}, 50);
					} catch {}
					recorder.start(250);
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: phase === "feedback" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: error }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => {
									if (inputActions.insertText(pending, inputActions.captureInsertion())) cancel();
								},
