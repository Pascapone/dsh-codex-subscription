...
`;
		...
		const zh = {
			...
			transcriptionTitle: "订阅语音转文字",
			transcription_on: "开启",
			transcription_off: "关闭",
			transcriptionHint: "实验功能，默认关闭。复用现有订阅登录，录音发送到 ChatGPT；停止后填入草稿，或点击发送箭头直接提交。无需其他语音插件。",
			voiceStart: "开始录音",
			voiceStop: "停止并转写",
			voiceSend: "转写并发送",
			voiceCancel: "取消录音",
			...
			voicePermission: "正在请求麦克风权限…",
			voiceEmpty: "录音为空",
			voiceLarge: "录音超过 25 MB",
			voiceFailed: "语音转写失败，请重试。",
			voiceSignedOut: "请先登录 ChatGPT 订阅。",
			voiceRenew: "登录已失效，请重新登录。",
			voiceDenied: "麦克风权限被拒绝。",
			voiceUnavailable: "当前浏览器不支持录音。",
			voiceChanged: "草稿已变化，请手动插入转写。",
		...
		const en = {
			...
			transcriptionTitle: "Subscription transcription",
			transcription_on: "On",
			transcription_off: "Off",
			transcriptionHint: "Experimental, off by default. Uses your subscription login and sends audio to ChatGPT. Stop to insert into the draft, or use the send arrow to transcribe and submit. No other voice plugin required.",
			voiceStart: "Start recording",
			voiceStop: "Stop and transcribe",
			voiceSend: "Transcribe and send",
			voiceCancel: "Cancel recording",
			voiceInsert: "Insert transcript",
			voiceRetry: "Retry",
			voiceRecording: "Recording…",
			voiceTranscribing: "Transcribing…",
			voicePermission: "Requesting microphone access…",
			voiceEmpty: "Recording is empty",
			voiceLarge: "Recording exceeds 25 MB",
			voiceFailed: "Transcription failed. Try again.",
			voiceSignedOut: "Sign in to your ChatGPT subscription first.",
			voiceRenew: "Sign in to ChatGPT again.",
			voiceDenied: "Microphone permission denied.",
			voiceUnavailable: "Recording is unavailable in this browser.",
			voiceChanged: "Your draft changed. Insert the transcript manually.",
...
.codexModelSelectCell:hover,.codexModelSelectCell:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:0}
...
.codexModelSelectGroupTitle{position:sticky;top:0;z-index:1;padding:5px 8px 3px;background:var(--dsw-specific-menu,var(--dsw-alias-bg-layer-1,#303136));color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:500;line-height:18px}
...
`;
		...
		*/
		...
		const SESSION_SPEED_MODES_FIELD = "sessionSpeedModes";
		...
		const supportsCodexFastMode = (modelId) => typeof modelId === "string" && (/^gpt-5\.(?:5|6)(?:$|-)/u.test(modelId) || modelId === "gpt-5.4" || /^gpt-6-(?:astra|sol|luna)$/u.test(modelId));
		//#endregion
		...
		function createPreferenceController(scope, rpc) {
			...
			let pendingPatch;
			let failedPatch;
			const pendingSpeeds = /* @__PURE__ */ new Map();
			let generation = 0;
			let contextModels = [];
			let verbosityModels = [];
			let fastModels;
			...
			const read = () => {
				...
				return Object.freeze({
					...
					sessionSpeedModes: {
						...value?.[SESSION_SPEED_MODES_FIELD],
						...Object.fromEntries(pendingSpeeds)
					},
			...
			const disposeScope = scope.subscribe(() => {
				for (const [id, mode] of pendingSpeeds) if (nativeSnapshot().value?.["sessionSpeedModes"]?.[id] === mode) pendingSpeeds.delete(id);
				error = false;
			...
			const acceptFallback = (value) => {
				...
				fallback = {
					...
					value: {
						...
						[SESSION_SPEED_MODES_FIELD]: value?.["sessionSpeedModes"] ?? {},
		...
		function CodexModelSelect({ locked, available, directory, load, select, preference, sessionId, t }) {
			const state = (0, react.useSyncExternalStore)(directory.subscribe, directory.getSnapshot);
			const preferenceSnapshot = usePreferenceSnapshot(preference);
			const [open, setOpen] = (0, react.useState)(false);
			const [pane, setPane] = (0, react.useState)("root");
			const [mobile, setMobile] = (0, react.useState)(() => window.matchMedia("(max-width:700px)").matches);
			const rootRef = (0, react.useRef)(null);
			const triggerRef = (0, react.useRef)(null);
			...
			const fast = speedSupported && preferenceSnapshot.sessionSpeedModes?.[sessionId] === "fast";
			...
			const chooseSpeed = (speedMode) => {
				close(true);
				preference.setSpeed(sessionId, speedMode);
			};
			...
			if (pane === "model") submenu = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "codexModelSelectPane",
				children: [
			...
			const menu = open ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				id: `${id}-menu`,
				role: "menu",
				"aria-label": paneTitle ?? t("modelMenuAria"),
				"aria-busy": state.status === "loading" || busy,
				children: [mobile && pane === "root" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "codexModelSelectMobileHeader",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("modelLabel") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						role: "menuitem",
				...
				}) : null, pane === "root" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					ref: backRef,
					className: "codexModelSelectBack",
					type: "button",
					role: "menuitem",
					onClick: backToRoot,
					"aria-label": `${t("modelBack")}: ${paneTitle}`,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconChevronLeftOutline14, {}), paneTitle]
				}), submenu] })]
			}) : null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), mobile && open ? (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "codexModelSelectMobileLayer",
					role: "dialog",
					"aria-modal": "true",
		...
		//#endregion
		//#region src/client-voice.jsx
		function CodexVoiceInput({ sessionId, inputActions, onActiveChange, locked, preference, voice, t }) {
			const { transcriptionEnabled } = usePreferenceSnapshot(preference);
			const { phase, wave, elapsed, error, hasText, inserted, sessionId: recordingSessionId } = (0, react.useSyncExternalStore)(voice.subscribe, voice.getSnapshot);
			...
			(0, react.useEffect)(() => {
				...
				let cancelled = false;
				queueMicrotask(() => {
					if (!cancelled) onActiveChange(true);
				});
				return () => {
					cancelled = true;
				};
			...
			if (phase === "idle") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				className: "codexVoiceTrigger",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: "codexVoiceButton",
					disabled: locked,
					title: t("voiceStart"),
					"aria-label": t("voiceStart"),
					onMouseDown: (event) => event.preventDefault(),
					onClick: () => {
						voice.start(sessionId, inputActions, locked);
					},
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
							...
							height: "12",
							rx: "3"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6 11a6 6 0 0 0 12 0M12 17v4m-4 0h8" })]
					})
				}), error && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					role: "alert",
					className: "codexVoiceError",
					children: error
				})]
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "codexVoiceControls",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "codexVoiceWave",
						role: "status",
						"aria-label": phase === "feedback" ? error : t(phase === "recording" ? "voiceRecording" : phase === "permission" ? "voicePermission" : "voiceTranscribing"),
						children: phase === "feedback" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "codexVoiceFeedback",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: error }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: voice.retry,
									children: t("voiceRetry")
								}),
								hasText && !inserted && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: voice.insert,
									children: t("voiceInsert")
								})
							]
						}) : phase === "recording" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "codexVoiceLive",
								"aria-hidden": "true",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {})
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "codexVoiceTrace",
								"aria-hidden": "true",
								children: wave.map((amplitude, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: {
									height: `${Math.round(3 + amplitude * 33)}px`,
									opacity: .35 + amplitude * .65
								} }, i))
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "codexVoiceTime",
								"aria-hidden": "true",
								children: [
						...
						] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(phase === "permission" ? "voicePermission" : "voiceTranscribing") })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "codexVoiceButton codexVoiceCancel",
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
							...
							strokeLinecap: "round",
							"aria-hidden": "true",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M5 5l14 14M19 5L5 19" })
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: "codexVoiceSpacer" }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "codexVoiceButton",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "codexVoiceButton codexVoiceSend",
						disabled: phase !== "recording",
		...
		function CodexVoiceSidebarIndicator({ voice, t }) {
			const sessionId = (0, react.useSyncExternalStore)(voice.subscribe, voice.getRecordingSession);
			if (!sessionId) return null;
			const cell = `[data-row-key="${CSS.escape(`session:${sessionId}`)}"]>span:first-child`;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("style", { children: `${cell}{position:relative}${cell}::after{content:"";position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:8px;height:8px;border-radius:50%;background:var(--dsw-alias-state-error-primary);animation:codexVoicePulse 1s ease-in-out infinite alternate}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "codexVoiceAnnouncement",
				role: "status",
				children: t("voiceRecording")
			})] });
		}
		function appendWave(history, amplitude) {
			return [...history.slice(1), Math.max(0, Math.min(1, amplitude))];
		}
		//#endregion
		//#region src/voice-controller.js
		const MIME_TYPES = [
		...
		const silentWave = () => Array(60).fill(0);
		function createVoiceController(sessions, rpc, t, conversation) {
			let state = {
				phase: "idle",
				wave: silentWave(),
				elapsed: 0,
			...
			const fail = (recording, failure) => {
				...
				const message = failure?.message === "ChatGPT subscription is not signed in" ? t("voiceSignedOut") : failure?.message === "ChatGPT sign-in needs to be renewed" ? t("voiceRenew") : [t("voiceEmpty"), t("voiceLarge")].includes(failure?.message) ? failure.message : t("voiceFailed");
				publish({
					phase: "feedback",
					error: message
				});
			...
			const submitDraft = (recording) => new Promise((resolve, reject) => {
				...
				const check = () => {
					...
					if (requestId && !snapshot.pendingSubmissions.some((item) => item.requestId === requestId)) queueMicrotask(() => {
						const failure = session.getSnapshot().promptError;
						settle(failure ? new Error(failure.error.message) : null);
					});
					else if (!requestId && snapshot.promptError && snapshot.promptError !== initial.promptError) settle(new Error(snapshot.promptError.error.message));
					else if (!requestId && input.state.getSnapshot().phase === "plain" && input.state.getSnapshot().draft.includes(recording.text)) queueMicrotask(() => {
						if (!done && !requestId && input.state.getSnapshot().phase === "plain" && input.state.getSnapshot().draft.includes(recording.text)) settle(new Error(t("voiceFailed")));
					});
				};
			...
			const deliver = async (recording) => {
				...
				try {
					if (!recording.text) {
						...
						recording.text = unwrap(await rpc.call(CHANNEL, "transcription/transcribe", {
							audioBase64: btoa(binary),
							mimeType: recording.audio.type
						}, recording.abort.signal)).text;
			...
			const start = async (sessionId, inputActions, locked = false) => {
				...
				if (!navigator.mediaDevices?.getUserMedia || typeof MediaRecorder === "undefined") {
					publish({ error: t("voiceUnavailable") });
					return;
				}
				const recording = {
				...
				try {
					recording.reference = sessions.retain(sessionId, { source: "controllerOperation" });
				} catch {
					publish({ error: t("voiceFailed") });
					return;
				}
				active = recording;
				publish({
				...
				try {
					...
					if (typeof AudioContext !== "undefined") try {
						...
						recording.waveTimer = setInterval(() => {
							...
							peak = Math.max(6, peak * .98, rms);
							publish({
								wave: appendWave(state.wave, (rms - 1.5) / peak * 1.3),
								elapsed: Math.floor((performance.now() - recording.startedAt) / 1e3)
							});
						}, 50);
					} catch {}
					recorder.start(250);
			...
			return {
				getSnapshot: () => state,
				getRecordingSession: () => state.phase === "recording" ? state.sessionId : null,
				subscribe: (listener) => {
					listeners.add(listener);
					return () => listeners.delete(listener);
				},
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "codexSubscriptionPreferenceLabel",
									children: t("transcriptionTitle")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "codexSubscriptionPreferenceHint",
									children: t("transcriptionHint")
								})]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "codexSubscriptionQuotaModes",
								role: "radiogroup",
								"aria-label": t("transcriptionTitle"),
								"aria-busy": snapshot.saving || void 0,
								children: [false, true].map((value) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									className: "codexSubscriptionQuotaMode",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										type: "radio",
										name: "codex-transcription",
										checked: snapshot.transcriptionEnabled === value,
										disabled: !snapshot.writable,
										onChange: () => {
											preference.set({ transcriptionEnabled: value });
										}
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t(value ? "transcription_on" : "transcription_off") })]
								}, String(value)))
							})]
						})
					}),
		...
		function apply(ctx) {
			...
			ctx.effect(() => {
				const unsubscribe = preference.subscribe(() => {
					if (!preference.getSnapshot().transcriptionEnabled) voice.cancel();
				});
				return () => {
					unsubscribe();
					voice.dispose();
