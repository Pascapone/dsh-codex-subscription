...
`;
		...
		*/
		...
		function CodexVoiceInput({ sessionId, inputActions, onActiveChange, locked, preference, voice, t }) {
			...
			const { phase, wave, elapsed, error, hasText } = (0, react.useSyncExternalStore)(voice.subscribe, voice.getSnapshot);
			(0, react.useLayoutEffect)(() => {
				onActiveChange(phase !== "idle" && transcriptionEnabled);
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: phase === "feedback" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								...
								hasText && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
		...
		function createVoiceController(sessions, rpc, t) {
			let state = {
				phase: "idle",
				wave: silentWave(),
				elapsed: 0,
			...
			const deliver = async (recording) => {
				...
				try {
					...
					if (active !== recording) return;
					if (recording.send) {
						const result = await recording.reference.binding.session.prompt([{
							type: "text",
							text: recording.text
						}], "queue", recording.abort.signal);
